...
impl<'w> AuraSysResource<'w> {
    pub(super) fn get_status_effect_data(&self, id: usize) -> Option<&AuraData> {
...
pub(super) fn get_resource() -> AuraDatabase {
    AuraDatabase(vec![
        ...
        AuraData::new("Arcane Shield".into(), 10, Duration::from_secs(5), crate::game::auras::StatusEffectType::Shield),
    ])
}